...
from op_brains.config import SUMMARIZER_MODEL
...
def summarize_all_threads(model_name):
    return summarize_some_threads(1.0, model_name)
...
def main():
    file = importlib.resources.open_text(op_artifacts, "all_thread_summaries.txt")
