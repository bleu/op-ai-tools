...
from op_brains.utils import (
    get_rag_model,
    process_question,
    process_question_stream,
)
from op_brains.exceptions import UnsupportedVectorstoreError, OpChatBrainsException
...
@patch("op_brains.model.RAGSystem.SimpleClaude")
...
@patch("op_brains.utils.get_rag_model")
...
@patch("op_brains.utils.get_rag_model")
def test_process_question_op_brains_exception(
...
@patch("op_brains.utils.get_rag_model")
def test_process_question_stream_op_brains_exception(
    mock_get_rag_model, mock_config, mock_logger
):
    mock_get_rag_model.side_effect = OpChatBrainsException("Test error")
