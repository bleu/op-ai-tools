...
from op_chat_brains.setup import main as setup_main


@patch("os.makedirs")
@patch("op_chat_brains.setup.OptimismDocumentProcessorFactory")
@patch("op_chat_brains.setup.DocumentLoader")
