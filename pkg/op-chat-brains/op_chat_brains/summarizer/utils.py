...
class Prompt:
    ...
    For "guide":
    <about>: Summarize what the guide helps with
    <overview>: Summarize the instructions, ideas or steps provided
    <reaction>: Summarize the relevant content in the thread that brings new information (not just opinions) WITHOUT MENTIONING USERS. If there is no relevant content, you can skip this section.
