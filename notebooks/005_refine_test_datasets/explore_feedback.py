...
relevant_questions_without_problems = relevant_questions[relevant_questions['corrections to the answer'].isnull() & relevant_questions['notes'].isnull()]
relevant_questions_without_problems = relevant_questions_without_problems.drop(columns=['is the question relevant? (0/1)', 'is the answer right? (0/1)', 'corrections to the answer', 'notes'])
...
relevant_questions_with_problems = relevant_questions[relevant_questions['corrections to the answer'].notnull() | relevant_questions['notes'].notnull()]
relevant_questions_with_problems = relevant_questions_with_problems.drop(columns=['is the question relevant? (0/1)', 'is the answer right? (0/1)'])
